...
Original file is located at
    https://colab.research.google.com/drive/17DMvu4hfXBd2sgyLmrwTBtCHU8WkPWfH

#그래프 연산

https://velog.io/@sch804/%EB%B0%91%EB%B0%94%EB%8B%A5%EB%B6%80%ED%84%B0-%EC%8B%9C%EC%9E%91%ED%95%98%EB%8A%94-%EB%94%A5%EB%9F%AC%EB%8B%9D-Chapter5
"""
...
class mse_graph:
    ...
    def backward(self, x):
        ...
        dweight_mse = ((self.y - self.t) * x).sum() * 2 / batch_size
        dbias_mse = (self.y - self.t).sum() * 2 / batch_size
...
dall_price, dtax = mul_tax_graph.backward(dtotal_price)
